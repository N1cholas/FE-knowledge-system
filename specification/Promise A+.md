...
> 原文：https://github.com/promises-aplus/promises-spec
>
...
1. `then` must return a promise [[3.3](#notes)].
    ...
    1. If either `onFulfilled` or `onRejected` returns a value `x`, run the MyPromise Resolution Procedure `[[Resolve]](promise2, x)`.
...
### The MyPromise Resolution Procedure
...
<p xmlns:dct="http://purl.org/dc/terms/" xmlns:vcard="http://www.w3.org/2001/vcard-rdf/3.0#">
  ...
  <span property="dct:title">Promises/A+ MyPromise Specification</span>.
